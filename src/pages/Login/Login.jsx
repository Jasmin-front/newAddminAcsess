...
import {getUserData} from "../../features/loginReducer/loginReducer.js";
    ...
    return (
        <div className='login'>
                <form className='login-main' onSubmit={handleSubmit(onSubmit)}>
                    ...
                    />
                    <input type="password" className='login-input' placeholder="Password" {...register("password", { required: true })} />
