...
import { fetchPayments } from '../../../entity/reducerPayment/paymentReducer';

const PaymentDelete = ({ client_id, id }) => {
	...
	const handleDelete = async e => {
		e.preventDefault();
		await request(`/workers/client/${client_id}/payments/${id}/`);
		await dispatch(fetchPayments(client_id));
		closeModal();
	};
	return (
		<>
