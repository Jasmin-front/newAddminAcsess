...
const UserDocumentDelete = ({ client_id, id }) => {
	...
	const handleDelete = async e => {
		e.preventDefault();
		await request(`/workers/client/${client_id}/documents/${id}/`);
		await dispatch(fetchDocuments(client_id));
		closeModal();
	};
	return (
		<>
...
export default UserDocumentDelete;
